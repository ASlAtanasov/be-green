        ...
        <section id="register-page" className="register register-section">
            <form id="register-form" className='register-section-form' method="POST" onSubmit={registerSubmitHandler}>
                <fieldset>
                    ...
                    <section>
                        <article className="field register-section-form-fieldset-article-address">
                            <p className="field register-section-form-fieldset-p-phone">
                                <label htmlFor="phone">Enter your address:</label>
                            </p>
                            <p className="field register-section-form-fieldset-article-p">
                            ...
                            <p className="field register-section-form-fieldset-article-p">
                                <label htmlFor="postCode">Postal Code or ZIP:</label>
                                <span className="input">
                                    <input type="number" name="postalCode" id="postCode" placeholder="" />
                                </span>
                            </p>
                        </article>
                    </section>
